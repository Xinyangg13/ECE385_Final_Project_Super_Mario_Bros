...
#
# Generated by Vivado on Mon Dec 08 15:35:26 -0600 2025
...
simulate()
{
  xsim  fifo_generator_0 -key {Behavioral:sim_1:Functional:fifo_generator_0} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_mario.protoinst" -log simulate.log
}
