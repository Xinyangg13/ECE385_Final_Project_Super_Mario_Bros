...
#
# Generated by export_simulation on Fri Nov 21 11:49:05 -0600 2025
#
################################################################################
...
'-reset_run' switch to the './clk_wiz_0_1.sh' script.

./clk_wiz_0_1.sh -reset_run
...
./clk_wiz_0_1.sh -noclean_files

For more information on the script, please type './clk_wiz_0_1.sh -help'.
