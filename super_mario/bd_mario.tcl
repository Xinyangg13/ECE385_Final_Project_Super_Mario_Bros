...
################################################################
# This is a generated script based on design: bd_mario
#
...
proc write_mig_file_bd_mario_mig_7series_0_0 { str_mig_prj_filepath } {
   ...
   puts $mig_prj_file {  <ModuleName>bd_mario_mig_7series_0_0</ModuleName>}
   ...
   puts $mig_prj_file {      <Pin IN_TERM="" IOSTANDARD="LVCMOS33" PADName="N15" SLEW="" VCCAUX_IO="" name="clk_100mhz"/>}
   ...
   puts $mig_prj_file {      <Pin IN_TERM="" IOSTANDARD="LVCMOS33" PADName="B16" SLEW="SLOW" VCCAUX_IO="" name="uart_rxd"/>}
   puts $mig_prj_file {      <Pin IN_TERM="" IOSTANDARD="LVCMOS33" PADName="A16" SLEW="" VCCAUX_IO="" name="uart_txd"/>}
   puts $mig_prj_file {    </PinSelection>}
   puts $mig_prj_file {    <System_Clock>}
   puts $mig_prj_file {      <Pin Bank="35" PADName="C1/B1(CC_P/N)" name="sys_clk_p/n"/>}
   puts $mig_prj_file {    </System_Clock>}
...
# End of write_mig_file_bd_mario_mig_7series_0_0()
...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set PixelClk_0 [ create_bd_port -dir I -type clk PixelClk_0 ]
  set SerialClk_0 [ create_bd_port -dir I -type clk SerialClk_0 ]
  ...
  set ui_addn_clk_1_0 [ create_bd_port -dir O -type clk ui_addn_clk_1_0 ]
  set vid_pData_0 [ create_bd_port -dir I -from 23 -to 0 vid_pData_0 ]
  set vid_pHSync_0 [ create_bd_port -dir I vid_pHSync_0 ]
  set vid_pVDE_0 [ create_bd_port -dir I vid_pVDE_0 ]
  set vid_pVSync_0 [ create_bd_port -dir I vid_pVSync_0 ]
  ...
  set_property -dict [list \
    ...
    CONFIG.C_S_AXI_ACLK_FREQ_HZ_d {83.333333} \
  ] $axi_uartlite_0
  ...
  set_property -dict [list \
    ...
    CONFIG.CLKOUT1_JITTER {377.563} \
    CONFIG.CLKOUT1_PHASE_ERROR {379.686} \
    CONFIG.CLKOUT1_REQUESTED_OUT_FREQ {25.175} \
    CONFIG.CLKOUT2_JITTER {294.836} \
    CONFIG.CLKOUT2_PHASE_ERROR {379.686} \
  ...
  write_mig_file_bd_mario_mig_7series_0_0 $str_mig_file_path
  ...
  # Create instance: rst_clk_wiz_0_124M, and set properties
  set rst_clk_wiz_0_124M [ create_bd_cell -type ip -vlnv xilinx.com:ip:proc_sys_reset:5.0 rst_clk_wiz_0_124M ]
  ...
  connect_bd_intf_net -intf_net axi_gpio_2_GPIO [get_bd_intf_ports GPIO_0] [get_bd_intf_pins axi_gpio_2/GPIO]
  connect_bd_intf_net -intf_net axi_gpio_3_GPIO [get_bd_intf_ports GPIO_1] [get_bd_intf_pins axi_gpio_3/GPIO]
  ...
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_M08_AXI [get_bd_intf_pins microblaze_0_axi_periph/M08_AXI] [get_bd_intf_pins spi_usb/AXI_LITE]
  ...
  connect_bd_net -net PixelClk_0_1 [get_bd_ports PixelClk_0] [get_bd_pins rgb2dvi_0/PixelClk]
  connect_bd_net -net SerialClk_0_1 [get_bd_ports SerialClk_0] [get_bd_pins rgb2dvi_0/SerialClk]
  ...
  connect_bd_net -net clk_wiz_0_clk_out2 [get_bd_ports clk_out2_0] [get_bd_pins clk_wiz_0/clk_out2] [get_bd_pins microblaze_0_axi_periph/M07_ACLK] [get_bd_pins rst_clk_wiz_0_124M/slowest_sync_clk]
  connect_bd_net -net clk_wiz_0_locked [get_bd_pins clk_wiz_0/locked] [get_bd_pins rst_clk_wiz_0_124M/dcm_locked] [get_bd_pins rst_mig_7series_0_83M/dcm_locked]
  connect_bd_net -net io1_i_0_1 [get_bd_ports io1_i_0] [get_bd_pins spi_usb/io1_i]
  ...
  connect_bd_net -net microblaze_0_Clk [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_gpio_1/s_axi_aclk] [get_bd_pins axi_gpio_2/s_axi_aclk] [get_bd_pins axi_gpio_3/s_axi_aclk] [get_bd_pins axi_timer_0/s_axi_aclk] [get_bd_pins axi_uartlite_0/s_axi_aclk] [get_bd_pins clk_wiz_0/clk_in1] [get_bd_pins microblaze_0/Clk] [get_bd_pins microblaze_0_axi_intc/processor_clk] [get_bd_pins microblaze_0_axi_intc/s_axi_aclk] [get_bd_pins microblaze_0_axi_periph/ACLK] [get_bd_pins microblaze_0_axi_periph/M00_ACLK] [get_bd_pins microblaze_0_axi_periph/M01_ACLK] [get_bd_pins microblaze_0_axi_periph/M02_ACLK] [get_bd_pins microblaze_0_axi_periph/M03_ACLK] [get_bd_pins microblaze_0_axi_periph/M04_ACLK] [get_bd_pins microblaze_0_axi_periph/M05_ACLK] [get_bd_pins microblaze_0_axi_periph/M06_ACLK] [get_bd_pins microblaze_0_axi_periph/M08_ACLK] [get_bd_pins microblaze_0_axi_periph/M09_ACLK] [get_bd_pins microblaze_0_axi_periph/S00_ACLK] [get_bd_pins microblaze_0_axi_periph/S01_ACLK] [get_bd_pins microblaze_0_axi_periph/S02_ACLK] [get_bd_pins microblaze_0_axi_periph/S03_ACLK] [get_bd_pins microblaze_0_axi_periph/S04_ACLK] [get_bd_pins mig_7series_0/ui_clk] [get_bd_pins rst_mig_7series_0_83M/slowest_sync_clk] [get_bd_pins spi_usb/ext_spi_clk] [get_bd_pins spi_usb/s_axi_aclk]
  ...
  connect_bd_net -net mig_7series_0_ui_addn_clk_1 [get_bd_ports ui_addn_clk_1_0] [get_bd_pins mig_7series_0/ui_addn_clk_1]
  connect_bd_net -net mig_7series_0_ui_clk_sync_rst [get_bd_pins clk_wiz_0/reset] [get_bd_pins mig_7series_0/ui_clk_sync_rst] [get_bd_pins rgb2dvi_0/aRst] [get_bd_pins rst_clk_wiz_0_124M/ext_reset_in]
  ...
  connect_bd_net -net rst_clk_wiz_0_124M_peripheral_aresetn [get_bd_pins microblaze_0_axi_periph/M07_ARESETN] [get_bd_pins rst_clk_wiz_0_124M/peripheral_aresetn]
  ...
  connect_bd_net -net rst_mig_7series_0_83M_peripheral_aresetn [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_gpio_1/s_axi_aresetn] [get_bd_pins axi_gpio_2/s_axi_aresetn] [get_bd_pins axi_gpio_3/s_axi_aresetn] [get_bd_pins axi_timer_0/s_axi_aresetn] [get_bd_pins axi_uartlite_0/s_axi_aresetn] [get_bd_pins microblaze_0_axi_intc/s_axi_aresetn] [get_bd_pins microblaze_0_axi_periph/ARESETN] [get_bd_pins microblaze_0_axi_periph/M00_ARESETN] [get_bd_pins microblaze_0_axi_periph/M01_ARESETN] [get_bd_pins microblaze_0_axi_periph/M02_ARESETN] [get_bd_pins microblaze_0_axi_periph/M03_ARESETN] [get_bd_pins microblaze_0_axi_periph/M04_ARESETN] [get_bd_pins microblaze_0_axi_periph/M05_ARESETN] [get_bd_pins microblaze_0_axi_periph/M06_ARESETN] [get_bd_pins microblaze_0_axi_periph/M08_ARESETN] [get_bd_pins microblaze_0_axi_periph/M09_ARESETN] [get_bd_pins microblaze_0_axi_periph/S00_ARESETN] [get_bd_pins microblaze_0_axi_periph/S01_ARESETN] [get_bd_pins microblaze_0_axi_periph/S02_ARESETN] [get_bd_pins microblaze_0_axi_periph/S03_ARESETN] [get_bd_pins microblaze_0_axi_periph/S04_ARESETN] [get_bd_pins mig_7series_0/aresetn] [get_bd_pins rst_mig_7series_0_83M/peripheral_aresetn] [get_bd_pins spi_usb/s_axi_aresetn]
  connect_bd_net -net spi_usb_io0_o [get_bd_ports io0_o_0] [get_bd_pins spi_usb/io0_o]
  connect_bd_net -net spi_usb_ip2intc_irpt [get_bd_pins microblaze_0_xlconcat/In2] [get_bd_pins spi_usb/ip2intc_irpt]
  connect_bd_net -net spi_usb_sck_o [get_bd_ports sck_o_0] [get_bd_pins spi_usb/sck_o]
  connect_bd_net -net spi_usb_ss_o [get_bd_ports ss_o_0] [get_bd_pins spi_usb/ss_o]
  connect_bd_net -net sys_rst_0_1 [get_bd_ports sys_rst_0] [get_bd_pins mig_7series_0/sys_rst] [get_bd_pins rst_mig_7series_0_83M/ext_reset_in]
  connect_bd_net -net vid_pData_0_1 [get_bd_ports vid_pData_0] [get_bd_pins rgb2dvi_0/vid_pData]
  connect_bd_net -net vid_pHSync_0_1 [get_bd_ports vid_pHSync_0] [get_bd_pins rgb2dvi_0/vid_pHSync]
  connect_bd_net -net vid_pVDE_0_1 [get_bd_ports vid_pVDE_0] [get_bd_pins rgb2dvi_0/vid_pVDE]
  connect_bd_net -net vid_pVSync_0_1 [get_bd_ports vid_pVSync_0] [get_bd_pins rgb2dvi_0/vid_pVSync]
  ...
  assign_bd_address -offset 0x00000000 -range 0x08000000 -target_address_space [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs mig_7series_0/memmap/memaddr] -force
  ...
  assign_bd_address -offset 0x40030000 -range 0x00010000 -target_address_space [get_bd_addr_spaces microblaze_0/Instruction] [get_bd_addr_segs axi_gpio_3/S_AXI/Reg] -force
  ...
  assign_bd_address -offset 0x00000000 -range 0x08000000 -target_address_space [get_bd_addr_spaces microblaze_0/Instruction] [get_bd_addr_segs mig_7series_0/memmap/memaddr] -force
  assign_bd_address -offset 0x44A00000 -range 0x00010000 -target_address_space [get_bd_addr_spaces microblaze_0/Instruction] [get_bd_addr_segs spi_usb/AXI_LITE/Reg] -force
